...
function renderHeader(){const d=new Date();document.querySelector('#todayLabel').textContent=`${d.getMonth()+1}月${d.getDate()}日 · ${['日','月','火','水','木','金','土'][d.getDay()]}曜日`;document.querySelector('#streakCount').textContent=calcStreak()}
